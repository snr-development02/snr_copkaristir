...
RegisterCommand('çöptopla', function()
	local playerPed = PlayerPedId()
        local entity, entityDst = ESX.Game.GetClosestObject(Config.prop)
            ...
            local binCoords = GetEntityCoords(entity)
               ...
               if IsPedInAnyVehicle(playerPed, false) then
                ...
                if not cachedBins[entity] then
                    ...
                    -- exports['mythic_notify']:DoHudText('error', 'Bu çöpü zaten karıştırdın')
...
function OpenTrashCan()
	...
	TriggerServerEvent("snr:retrieve")
